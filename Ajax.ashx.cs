...
namespace DealMvc
{
    ...
    public class Ajax : IHttpHandler
    {
        ...
        /// 临时目录
        /// </summary>
        static string temppath = "/" + DealMvc.Common.Config.ConfigInfo<DealMvc.Common.Config.UploadInfo>.Instance().UploadFolder.Replace("/", "") + "/" + "temp" + "/";
        /// <summary>
        /// 保存文件目录
        /// </summary>
        static string path = "/" + DealMvc.Common.Config.ConfigInfo<DealMvc.Common.Config.UploadInfo>.Instance().UploadFolder.Replace("/", "") + "/" + "pic" + "/";
