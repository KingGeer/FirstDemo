...
$(function ()
{
    $(".menu > .sub").hide().find("div p:not('.title')").hide().css("padding-left", "22px");
    ...
    $(".menu > a").css("display", "block").addClass("menua").each(
                function (i, v)
                {
                    $(v).click(function ()
                    {
                        ...
                        $(".leftMenu p").css("line-height", "34px").css("border-bottom", "1px solid #DDD");
                        $(".leftMenu a").css("text-decoration", "none").each(function (u, ele)
                        {
