...
function Dialog(contentObj, title, callBack, showBtn)
{
    ...
    $(document.body).append("<div id='____DialogDiv' class='Dialog'><div class='DTitle'><font>" + title + "</font><a class='Dclo noJ' href='javascript:DialogHide();'></a></div><div class='DCnt'></div><div class='DTitle'><input type='button' class='Dbtn' value='确&nbsp;认' /></div></div>");
    ...
    var Ch = parseInt((W_height - dialogDiv.height()) / 4) + S_top;
    /////////////////////////////////
